                ...
                <div class="right d-flex justify-content-center">
                    <div class="form bg-white rounded-5 p-5" style="width: 660px; height: fit-content;">
                       ...
                       <form id="signin">
                            @csrf
                            <div class="mb-3">
                                <label for="email" class="fs-5 fw-semibold">Email Address</label>
                            ...
                            <div>
                                <label for="password" class="fs-5 fw-medium">Password</label>
                                <input type="password" name="password" id="password" placeholder="Enter your Password" class="ps-3 mb-2 mt-3 border-secondary-subtle rounded-pill border border-1 border-opacity-50" style="padding: 15px;">
                            </div>
                            <div class="remember d-flex justify-content-between mt-2">
                        ...
                        <p class="mt-4 text-center fs-6" style="Display:none;">Don't have an account? <a href="{{ route('signup') }}" class="text-decoration-none">Sign Up</a>
                        </p>
                    </div>
                </div>
            </div>
